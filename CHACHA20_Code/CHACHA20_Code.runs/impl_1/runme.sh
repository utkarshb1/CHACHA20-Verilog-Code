...
HD_PWD='C:/Users/utkar/Documents/ISE/Vivado/chacha1/chacha1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log chacha.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source chacha.tcl -notrace
