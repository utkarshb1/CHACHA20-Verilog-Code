...
HD_PWD='C:/Users/utkar/Documents/ISE/Vivado/chacha1/chacha1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log chacha.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source chacha.tcl
